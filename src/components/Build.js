...
export default function Build(props) {
    ...
    return (
        <div className="build-container">
            {!props.object && <button className="add-settlement-button" onClick={() => addSettle()} >Add Settlement</button>}
            ...
            {props.object && <div className="resource-container">
...
function DropdownItems(props) {
    ...
    return (
        <div className="dropdown-menu">
            {!resourcePicked &&
                <div className="choose-resource-text">
            ...
            {resourcePicked &&
                <div className="choose-roll-text">
                    <button className="number-buttons left-buttons" onClick={() => chooseRoll(2)}>2</button>
                    <button className="number-buttons right-buttons" onClick={() => chooseRoll(3)}>3</button>

                    <button className="number-buttons left-buttons" onClick={() => chooseRoll(4)}>4</button>
                    <button className="number-buttons right-buttons" onClick={() => chooseRoll(5)}>5</button>

                    <button className="number-buttons left-buttons" onClick={() => chooseRoll(6)}>6</button>
                    <button className="number-buttons right-buttons" onClick={() => chooseRoll(8)}>8</button>

                    <button className="number-buttons left-buttons" onClick={() => chooseRoll(9)}>9</button>
                    <button className="number-buttons right-buttons" onClick={() => chooseRoll(10)}>10</button>

                    <button className="number-buttons left-buttons" onClick={() => chooseRoll(11)}>11</button>
                    <button className="number-buttons right-buttons" onClick={() => chooseRoll(12)}>12</button>
